ALTER TABLE soc.ln_timemeetgo DROP CONSTRAINT IF EXISTS fk_activitesuuid_ref_users;
ALTER TABLE soc.ln_timemeetgo DROP CONSTRAINT IF EXISTS fk_timedmeetgouuid_ref_users;
