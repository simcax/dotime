...
class SettingsHandling:
    ...
    def add_defaults(self, user_id):
        ...
        for i in range(1, 8):
            ...
            hour_setting_added = self.add_setting(
            ...
            minutes_setting_added = self.add_setting(
                user_id, settings_name, settings_value
            )
    ...
    def get_workweek_day_lengths(self, user_id):
        ...
        workweek_day_lengths = {
            k: v for k, v in settings.items() if k.startswith("workdayLength")
        }
    ...
    def get_number_of_work_hours_until_current_day(self, user_id, day_number):
        ...
        Returning the intended number of hours, which should be worked
        as taken from the user settings
        The day number should be 1 = Monday, 2 = Tuesday, 3 = Wednesday, 4 = Thursday, 5 = Friday,
        6 = Saturday, 7 = Sunday
